...
export default class MediaStreamTrack extends EventTarget {
   ...
   */
  async initializeEffectsSDK(customerId, url) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  setEffectsSdkPipelineMode(pipelineMode) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  setEffectsSdkBlurPower(blurPower) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  enableEffectsSdkVideoStream(enabled) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  enableEffectsSdkBeautification(enabled) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  async isEffectsSdkBeautificationEnabled() {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  setEffectsSdkBeautificationPower(power) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  setEffectsSdkZoomLevel(zoomLevel) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  enableEffectsSdkSharpening(enabled) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  setEffectsSdkSharpeningStrength(strength) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  async getEffectsSdkSharpeningStrength() {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  setEffectsSdkColorFilterStrength(strength) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  setEffectsSdkColorCorrectionMode(mode) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
