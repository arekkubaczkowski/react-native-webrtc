...
class MediaStreamTrack extends EventTarget {
   ...
   */
  async _initializeEffectsSDK(customerId, url) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  _setEffectsSdkPipelineMode(pipelineMode) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  _setEffectsSdkBlurPower(blurPower) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  _enableEffectsSdkVideoStream(enabled) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  _enableEffectsSdkBeautification(enabled) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  async _isEffectsSdkBeautificationEnabled() {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  _setEffectsSdkBeautificationPower(power) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  _setEffectsSdkZoomLevel(zoomLevel) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  _enableEffectsSdkSharpening(enabled) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  _setEffectsSdkSharpeningStrength(strength) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  async _getEffectsSdkSharpeningStrength() {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  _setEffectsSdkColorFilterStrength(strength) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
   ...
   */
  _setEffectsSdkColorCorrectionMode(mode) {
    if (this.remote) {
      throw new Error('Not implemented for remote tracks');
    }
    if (this.kind !== 'video') {
