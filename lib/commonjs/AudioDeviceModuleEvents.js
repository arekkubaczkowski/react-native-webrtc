...
exports.audioDeviceModuleEvents = void 0;
...
class AudioDeviceModuleEventEmitter {
  ...
  setupListeners() {
    if (_reactNative.Platform.OS !== 'android' && WebRTCModule) {
      ...
      (0, _EventEmitter.addListener)(this, 'audioDeviceModuleEngineCreated', async event => {
        const {
          requestId
        } = event;
        let result = 0;
      ...
      (0, _EventEmitter.addListener)(this, 'audioDeviceModuleEngineWillEnable', async event => {
        const {
          requestId,
          isPlayoutEnabled,
          isRecordingEnabled
      ...
      (0, _EventEmitter.addListener)(this, 'audioDeviceModuleEngineWillStart', async event => {
        const {
          requestId,
          isPlayoutEnabled,
          isRecordingEnabled
      ...
      (0, _EventEmitter.addListener)(this, 'audioDeviceModuleEngineDidStop', async event => {
        const {
          requestId,
          isPlayoutEnabled,
          isRecordingEnabled
      ...
      (0, _EventEmitter.addListener)(this, 'audioDeviceModuleEngineDidDisable', async event => {
        const {
          requestId,
          isPlayoutEnabled,
          isRecordingEnabled
      ...
      (0, _EventEmitter.addListener)(this, 'audioDeviceModuleEngineWillRelease', async event => {
        const {
          requestId
        } = event;
        let result = 0;
  ...
  addSpeechActivityListener(listener) {
    (0, _EventEmitter.addListener)(listener, 'audioDeviceModuleSpeechActivity', listener);
  }
  ...
  addDevicesUpdatedListener(listener) {
    (0, _EventEmitter.addListener)(listener, 'audioDeviceModuleDevicesUpdated', listener);
  }
...
const audioDeviceModuleEvents = new AudioDeviceModuleEventEmitter();
exports.audioDeviceModuleEvents = audioDeviceModuleEvents;
